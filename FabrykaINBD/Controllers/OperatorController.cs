...
namespace FabrykaINBD.Controllers
{
    public class OperatorController : Controller
    {
        ...
        {
            return View(await _context.Operatorzy.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var @operator = await _context.Operatorzy
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var @operator = await _context.Operatorzy.FindAsync(id);
            if (@operator == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (@operator != null)
            {
                _context.Operatorzy.Remove(@operator);
            }
        ...
        {
            return _context.Operatorzy.Any(e => e.Id == id);
        }
    }
}
